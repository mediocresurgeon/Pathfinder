...
{
    internal sealed class ColdResistance : EnergyResistanceEnchantment
    {
        /// <summary>
        /// Initializes a new instance of the
        /// <see cref="T:Core.Domain.Items.Armor.Enchantments.Paizo.CoreRulebook.ColdResistance"/> class.
        /// </summary>
