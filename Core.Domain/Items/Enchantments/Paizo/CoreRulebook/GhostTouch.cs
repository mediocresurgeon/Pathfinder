...
{
    internal sealed class GhostTouch : IArmorEnchantment, IShieldEnchantment
    {
        #region Constructor
        internal GhostTouch()
        {
        ...
        public INameFragment Name { get; } = new NameFragment("Ghost Touch", "http://www.d20pfsrd.com/magic-items/magic-armor/magic-armor-and-shield-special-abilities/ghost-touch/");
