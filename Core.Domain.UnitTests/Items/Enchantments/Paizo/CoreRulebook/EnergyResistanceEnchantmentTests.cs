...
namespace Core.Domain.UnitTests.Items.Shields.Enchantments.Paizo.CoreRulebook
{
    [TestFixture]
    [Parallelizable]
    public class EnergyResistanceEnchantmentTests
    {
        #region Constructor
        ...
        public void Constructor_NullElement_Throws()
        {
            ...
            TestDelegate constructor = () => {
                var mockEnergyResistance = new Mock<EnergyResistanceEnchantment>(MockBehavior.Loose, elementName, resistanceExpression, protectionLevel) { CallBase = true };
        ...
        public void ApplyTo_NullCharacter_Throws()
        {
            ...
            var energyResistance = new Mock<EnergyResistanceEnchantment>(MockBehavior.Loose, elementName, resistanceExpression, protectionLevel) { CallBase = true }.Object;
